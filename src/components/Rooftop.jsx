...
export default function Rooftop() {
  return (
    ...
    >
      ...
      <div className="relative z-10 px-[60px] py-[120px] max-w-[600px]">
        <p className="section-tag-line flex items-center gap-5 text-[9px] tracking-[0.4em] uppercase text-warm mb-[60px]">
          Rooftop Club
        </p>

        <h2
          className="font-serif font-light leading-none tracking-[-0.02em] mb-7"
        ...
        <p className="text-[13px] text-offwhite/60 leading-[1.9] mb-12">
        ...
        <div className="flex flex-wrap gap-3 mb-12">
          {amenities.map((a) => (
            <span
              key={a}
              className="text-[9px] tracking-widest2 uppercase text-warm py-2 px-4"
